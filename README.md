...
- Computer science: binary trees, linked lists, stacks, queues, hash tables, call
  stacks, dynamic-programming tables, architecture diagrams, and state machines.
- Projects and business: Gantt charts, work-breakdown structures, project
  networks, timelines, flow diagrams, and T-accounts.
