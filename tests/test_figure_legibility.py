...
CORPUS: dict[str, dict] = {
    ...
    'sequence_diagram': {"event_label": "event", "participants": [{"id": "worker", "label": "Worker", "sub": "runs AgentRun"}, {"id": "svc", "label": "Temporal Service"}], "rows": [{"from": "worker", "to": "svc", "label": "Command StartTimer(20 s)", "event": 11}, {"note": "no Worker process exists", "over": "worker"}, {"gap": "20 s on the Service's clock", "breaks": ["worker"]}, {"self": "svc", "label": "TimerFired", "event": 12}, {"from": "svc", "to": "worker", "label": "Workflow Task", "event": 13, "style": "dashed"}]},
